                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="about-text ml_60">
                                ...
                                <h4 class="mb_20">Bitcoin is a revolutionary invention of the last decade. Its essential meaning is money digitization</h4>
                                <p>Many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden inenerators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet model. of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. Always free from repetition, injected humour, or non-characteristic words etc.</p>
                                <button class="custom-btn custom-btns mtb_20" type="button"><span>View More Info</span></button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section id="service" class="pt_100 pb_50">
        <div class="container text-center">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xs-6 mb_50">
                    <div class="service">
                        <div class="icon-top"><img src="images/serviceicon/service-2.png" alt="#"></div>
                        <h4 class="mtb_20">Mobile App</h4>
                        <p>It is a long established fact that reader distracted by the readable content of a page when looking at its layout.</p>
                    </div>
                </div>
                <div class="col-md-4 col-xs-6 mb_50">
                    <div class="service">
                        ...
                        <h4 class="mtb_20">Secure Wallet</h4>
                        <p>It is a long established fact that reader distracted by the readable content of a page when looking at its layout.</p>
                    </div>
                </div>
                <div class="col-md-4 col-xs-6 mb_50">
                    <div class="service">
                        ...
                        <h4 class="mtb_20">Covered By Insurance</h4>
                        <p>It is a long established fact that reader distracted by the readable content of a page when looking at its layout.</p>
                    </div>
                </div>
                <div class="col-md-4 col-xs-6 mb_50">
                    <div class="service">
                        ...
                        <h4 class="mtb_20">Recurring Buying</h4>
                        <p>It is a long established fact that reader distracted by the readable content of a page when looking at its layout.</p>
                    </div>
                </div>
                <div class="col-md-4 col-xs-6 mb_50">
                    <div class="service">
                        ...
                        <h4 class="mtb_20">Instant Exchange</h4>
                        <p>It is a long established fact that reader distracted by the readable content of a page when looking at its layout.</p>
                    </div>
                </div>
            </div>
    ...
    <section id="prices" class="prices">
        <div class="container">
            <div class="heading-part text-center">
                <h2 class="main_title mt_100 mb_20 wow fadeInUp" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">Crypto currency Prices</h2>
                <p class="mb_50">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Perspiciatis unde omnis iste natus error sit.</p>
            </div>
